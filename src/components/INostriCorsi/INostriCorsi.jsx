          ...
          <Row>
            ...
            >
              ...
              <p className={styles.testi}>
                ...
                scenica, fondamentale per chi si esibisce dal vivo. <br /> Il
                corso è ideale per chi aspira a diventare:
              </p>
              ...
              <p className={styles.testi}>
                Gli studenti avranno l'opportunità di esibirsi in:
              </p>
              <ul
                style={{
                  listStyleType: 'none',
          ...
          <Row>
            ...
            >
              ...
              <p className={styles.testi}>
                ...
                d'insegnamento alle esigenze individuali di ciascun cantante.{' '}
                <br /> Un forte focus sulla didattica musicale e l'educazione
                vocale è centrale nel programma. <br />
                Gli studenti apprenderanno strategie pedagogiche efficaci,
                tecniche di comunicazione e come creare un ambiente di
                apprendimento positivo e stimolante. <br />
                Attraverso laboratori pratici e sessioni di feedback, gli
                aspiranti Vocal Coach svilupperanno abilità critiche
                nell'osservare e analizzare le performance vocali, fornendo
                suggerimenti costruttivi e motivazione ai loro allievi. <br />
                Inoltre, il corso offre l'opportunità di partecipare a
                masterclass con artisti e insegnanti di fama nel settore, che
                condivideranno le loro esperienze e offriranno preziosi consigli
                pratici. <br />
                Gli studenti avranno anche la possibilità di esibirsi in
                concerti e showcase, mettendo in pratica ciò che hanno appreso e
                costruendo la loro rete professionale. <br />
                Alla fine del corso, i partecipanti avranno acquisito competenze
                necessarie per affrontare le sfide del mondo musicale
                contemporaneo e per ispirare e guidare altri nel loro viaggio
                artistico. Unisciti a noi per dare vita alla tua passione per il
                canto e trasformarla in un'opportunità professionale
                gratificante!
              </p>
            </Col>
      ...
      <div>
        <Container>
          <Row>
            ...
            >
              <h2 className={styles.titoli}>Corso di Pianoforte</h2>
              <p className={styles.testi}>
